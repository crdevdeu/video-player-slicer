...
export default (state = INITIAL_STATE, action) => {
  switch(action.type){
    case CREATE_NEW_CLIP:
      return { ...state, newclip: true, editclip:false, editindex: null, clipaddedsuccess: false, clipeditedsuccess: false, inputerror: false, playintervalerror: false };
